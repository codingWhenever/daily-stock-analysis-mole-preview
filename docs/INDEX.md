...
| [选基产品目标、当前状态与路线评审稿](funds-product-review-2026-06-26.md) | `/funds` 选基模块的评审版总览，明确产品目标、已实现边界、未实现能力和 P0-P7 优先级路线 |
| [选基决策系统数据基座、持仓导入与荐基规格](funds-decision-foundation-spec.md) | `/funds` 选基从公开基金数据、平台持仓导入、用户画像、市场热点、荐基榜、回测校准到明确决策动作的完整规格 |
